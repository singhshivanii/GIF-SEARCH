  ...
  return (
    <>
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <img
          className="logo"
          src="https://tse4.mm.bing.net/th?id=OIP.NWcw3Tf4CjMWtjPFI9aQEwHaHa&pid=Api&P=0&h=180"
          width={115}
          alt="logo"
        />
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  type="password"
                  autoComplete="current-password"
                  onChange={(e: { target: { value: SetStateAction<string>; }; }) => setPasswordAgain(e.target.value)}
                  required
                  className="block w-full rounded-lg border-gray-300 bg-white py-2 px-4 text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm"
                />
              </div>
